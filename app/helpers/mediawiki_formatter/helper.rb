  ...
  module Helper
    ...
    def wikitoolbar_for(field_id)
      ...
      url = Redmine::Utils.relative_url_root + 
            Engines::RailsExtensions::AssetHelpers.plugin_asset_path('redmine_markups', 'help', 'mediawiki_syntax.html')
    ...
    def heads_for_wiki_formatter
      unless @heads_for_wiki_formatter_included
        content_for :header_tags do
          ...
          javascript_include_tag('mediawiki', :plugin => 'redmine_markups') +
